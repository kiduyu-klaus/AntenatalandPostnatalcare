...
public class FragmentQuestion3 extends Fragment {
    ...
    String question1 = "Do you have difficulty in breathing, high blood sugar and temperature rise?";


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View layout = inflater.inflate(R.layout.fragment_question3, container, false);
    ...
    private void SaveToDb(String answer) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                RootRef.child(Prevalent.currentOnlineUser.getName()).child("question3").setValue(answer);
                loadingBar.dismiss();
                getActivity().getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.fragment_container,
                        new FragmentQuestion4()).commit();
