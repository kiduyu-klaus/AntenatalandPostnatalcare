...
public class BookAppointment extends AppCompatActivity implements View.OnClickListener {
            ...
            public void onClick(View v) {
                ...
                if (!dateValue.isEmpty()) {
                    ...
                    if (flagChecked == 0) {
                        ...
                        String consultant_phone = getIntent().getStringExtra("consultant_phone");
    ...
    private void SendToDb(String consultant, String username, String userphone, String consultant_phone, String dateValue, final String time) {
       ...
       final Application application = new Application(consultant, username,userphone,consultant_phone,dateValue,time,"","Pending");


        final DatabaseReference RootRef;

        RootRef = FirebaseDatabase.getInstance().getReference().child("Appointments");;

        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (!(dataSnapshot.child(Prevalent.currentOnlineUser.getName()).child(dateValue).exists())){
                    RootRef.child(Prevalent.currentOnlineUser.getName()).child(dateValue).setValue(application);
                    ...
                    Toast.makeText(BookAppointment.this, "Appointment Already made.", Toast.LENGTH_SHORT).show();
                    loadingBar.dismiss();
                }
            }
