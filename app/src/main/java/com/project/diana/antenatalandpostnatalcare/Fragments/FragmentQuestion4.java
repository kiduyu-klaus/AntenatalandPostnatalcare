...
public class FragmentQuestion4 extends Fragment {
    ...
    String question1 = "Do you have lack of or no heartbeat by week 10?";


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View layout = inflater.inflate(R.layout.fragment_question4, container, false);
    ...
    private void SaveToDb(String answer) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                RootRef.child(Prevalent.currentOnlineUser.getName()).child("question4").setValue(answer);
                loadingBar.dismiss();
                getActivity().getSupportFragmentManager().beginTransaction().addToBackStack(null).replace(R.id.fragment_container,
                        new FragmentQuestion5()).commit();
