...
public class FragmentQuestion5 extends Fragment {
    ...
    String question1 = "Do you Experience excessive cramping?";


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        final View layout = inflater.inflate(R.layout.fragment_question5, container, false);
    ...
    private void SaveToDb(String answer) {
        ...
        RootRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                RootRef.child(Prevalent.currentOnlineUser.getName()).child("question5").setValue(answer);
                loadingBar.dismiss();
