...
import com.project.diana.antenatalandpostnatalcare.DoctorHome.DoctorHome;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vet_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                btnLogin.setText("Doctors Login");
                login_title.setText("Doctors Login");
        ...
        customer_txt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                login_title.setText("Users Login");
                parentDbName="Users";
